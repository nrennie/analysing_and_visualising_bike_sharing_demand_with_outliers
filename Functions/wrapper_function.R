...
wrapper_function <- function(input_data, input_mat, times=0:23, perc=0.01, B=10, corr_threshold=0.15, weekday=c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday"), weekend=c("Saturday", "Sunday"), summer=c("April", "May", "June", "July", "August", "September", "October"), winter=c("November", "December", "January", "February", "March")){
